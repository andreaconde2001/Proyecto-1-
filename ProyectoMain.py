  ...
  if opcion == "1":
    ...
    while opc1 !=3:
      ...
      if opc1 == "1":
        ...
        input("\n"
          "Datos ingresados de manera correcta, presiona una tecla para continuar.")
      elif opc1 == "2":
        ...
        input("Espere!!" 
        "\n" "Gracias por la espera. Presione una tecla para continuar.")
        break
    ...
    while opc1 !=3:
      ...
      if opc1 == "1":
        ...
        crg = buscarcargo(codCargo)
        while crg != codCargo:
          codCargo= input("Cargo del Empleado: ")
          crg = buscarcargo(codCargo)
        Dep= input("Departamento del Empleado: ")
        depto = buscardept(Dep)
        while depto != Dep:
          Dep= input("Departamento del Empleado: ")
          depto = buscardept(Dep)
        ...
        while sueldo %1 == 0:
          sueldo= float(input("Sueldo del Empleado: "))  
        empl = Empleado(nombre,cedula,codCargo,Dep,sueldo)
        ...
        input("Espere!!" 
        "\n" "Gracias por su espera. Presione una tecla para continuar...")
        break
  elif opcion == "4":
